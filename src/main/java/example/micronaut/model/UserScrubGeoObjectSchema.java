 ...
 */
@JsonPropertyOrder({
  UserScrubGeoObjectSchema.JSON_PROPERTY_EVENT_AT,
  UserScrubGeoObjectSchema.JSON_PROPERTY_UP_TO_TWEET_ID,
  UserScrubGeoObjectSchema.JSON_PROPERTY_USER
})
@JsonTypeName("UserScrubGeoObjectSchema")
...
public class UserScrubGeoObjectSchema {
    ...
    public static final String JSON_PROPERTY_UP_TO_TWEET_ID = "up_to_tweet_id";
    private String upToTweetId;

    public static final String JSON_PROPERTY_USER = "user";
    private UserComplianceSchemaUser user;

    public UserScrubGeoObjectSchema(OffsetDateTime eventAt, String upToTweetId, UserComplianceSchemaUser user) {
    ...
    @JsonProperty(JSON_PROPERTY_UP_TO_TWEET_ID)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
