 ...
 */
@JsonPropertyOrder({
  Get2ComplianceJobsResponse.JSON_PROPERTY_DATA,
  Get2ComplianceJobsResponse.JSON_PROPERTY_ERRORS,
  Get2ComplianceJobsResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2ComplianceJobsResponse")
