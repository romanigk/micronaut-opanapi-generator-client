 ...
 */
@JsonPropertyOrder({
  Get2TweetsSearchStreamResponse.JSON_PROPERTY_DATA,
  Get2TweetsSearchStreamResponse.JSON_PROPERTY_ERRORS,
  Get2TweetsSearchStreamResponse.JSON_PROPERTY_INCLUDES
})
@JsonTypeName("Get2TweetsSearchStreamResponse")
