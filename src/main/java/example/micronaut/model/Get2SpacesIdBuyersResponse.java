 ...
 */
@JsonPropertyOrder({
  Get2SpacesIdBuyersResponse.JSON_PROPERTY_DATA,
  Get2SpacesIdBuyersResponse.JSON_PROPERTY_ERRORS,
  Get2SpacesIdBuyersResponse.JSON_PROPERTY_INCLUDES,
  Get2SpacesIdBuyersResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2SpacesIdBuyersResponse")
