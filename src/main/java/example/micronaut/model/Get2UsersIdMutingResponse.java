 ...
 */
@JsonPropertyOrder({
  Get2UsersIdMutingResponse.JSON_PROPERTY_DATA,
  Get2UsersIdMutingResponse.JSON_PROPERTY_ERRORS,
  Get2UsersIdMutingResponse.JSON_PROPERTY_INCLUDES,
  Get2UsersIdMutingResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2UsersIdMutingResponse")
