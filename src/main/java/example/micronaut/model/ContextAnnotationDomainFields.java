 ...
 */
@JsonPropertyOrder({
  ContextAnnotationDomainFields.JSON_PROPERTY_DESCRIPTION,
  ContextAnnotationDomainFields.JSON_PROPERTY_ID,
  ContextAnnotationDomainFields.JSON_PROPERTY_NAME
})
@JsonTypeName("ContextAnnotationDomainFields")
...
public class ContextAnnotationDomainFields {
    ...
    public ContextAnnotationDomainFields(String id) {
        this.id = id;
    }
