 ...
 */
@JsonPropertyOrder({
  Get2UsersIdPinnedListsResponse.JSON_PROPERTY_DATA,
  Get2UsersIdPinnedListsResponse.JSON_PROPERTY_ERRORS,
  Get2UsersIdPinnedListsResponse.JSON_PROPERTY_INCLUDES,
  Get2UsersIdPinnedListsResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2UsersIdPinnedListsResponse")
