 ...
 */
@JsonPropertyOrder({
  Get2SpacesSearchResponse.JSON_PROPERTY_DATA,
  Get2SpacesSearchResponse.JSON_PROPERTY_ERRORS,
  Get2SpacesSearchResponse.JSON_PROPERTY_INCLUDES,
  Get2SpacesSearchResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2SpacesSearchResponse")
