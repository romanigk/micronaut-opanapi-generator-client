 ...
 */
@JsonPropertyOrder({
  Get2UsersByResponse.JSON_PROPERTY_DATA,
  Get2UsersByResponse.JSON_PROPERTY_ERRORS,
  Get2UsersByResponse.JSON_PROPERTY_INCLUDES
})
@JsonTypeName("Get2UsersByResponse")
