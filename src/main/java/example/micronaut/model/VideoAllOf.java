 ...
 */
@JsonPropertyOrder({
  VideoAllOf.JSON_PROPERTY_DURATION_MS,
  VideoAllOf.JSON_PROPERTY_NON_PUBLIC_METRICS,
  VideoAllOf.JSON_PROPERTY_ORGANIC_METRICS,
  VideoAllOf.JSON_PROPERTY_PREVIEW_IMAGE_URL,
  VideoAllOf.JSON_PROPERTY_PROMOTED_METRICS,
  VideoAllOf.JSON_PROPERTY_PUBLIC_METRICS,
  VideoAllOf.JSON_PROPERTY_VARIANTS
})
@JsonTypeName("Video_allOf")
