 ...
 */
@JsonPropertyOrder({
  Get2TweetsSample10StreamResponse.JSON_PROPERTY_DATA,
  Get2TweetsSample10StreamResponse.JSON_PROPERTY_ERRORS,
  Get2TweetsSample10StreamResponse.JSON_PROPERTY_INCLUDES
})
@JsonTypeName("Get2TweetsSample10StreamResponse")
