 ...
 */
@JsonPropertyOrder({
  ResourceUnavailableProblemAllOf.JSON_PROPERTY_PARAMETER,
  ResourceUnavailableProblemAllOf.JSON_PROPERTY_RESOURCE_ID,
  ResourceUnavailableProblemAllOf.JSON_PROPERTY_RESOURCE_TYPE
})
@JsonTypeName("ResourceUnavailableProblem_allOf")
...
public class ResourceUnavailableProblemAllOf {
    ...
    public ResourceUnavailableProblemAllOf(String parameter, String resourceId, ResourceTypeEnum resourceType) {
