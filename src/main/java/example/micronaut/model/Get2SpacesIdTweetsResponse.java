 ...
 */
@JsonPropertyOrder({
  Get2SpacesIdTweetsResponse.JSON_PROPERTY_DATA,
  Get2SpacesIdTweetsResponse.JSON_PROPERTY_ERRORS,
  Get2SpacesIdTweetsResponse.JSON_PROPERTY_INCLUDES,
  Get2SpacesIdTweetsResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2SpacesIdTweetsResponse")
