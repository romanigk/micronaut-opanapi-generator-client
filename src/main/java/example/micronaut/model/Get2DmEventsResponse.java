 ...
 */
@JsonPropertyOrder({
  Get2DmEventsResponse.JSON_PROPERTY_DATA,
  Get2DmEventsResponse.JSON_PROPERTY_ERRORS,
  Get2DmEventsResponse.JSON_PROPERTY_INCLUDES,
  Get2DmEventsResponse.JSON_PROPERTY_META
})
@JsonTypeName("Get2DmEventsResponse")
